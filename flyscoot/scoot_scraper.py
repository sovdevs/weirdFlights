...
class ScootScraper:
    ...
    # Key SE Asia hubs and long-haul routes for bidirectional routes
    ROUTES = [
        # Long-haul: Europe/Middle East/US <-> Singapore
        ("SIN", "LGW"), ("LGW", "SIN"),
        ("SIN", "LHR"), ("LHR", "SIN"),
        ("SIN", "FRA"), ("FRA", "SIN"),
        ("SIN", "ZRH"), ("ZRH", "SIN"),
    ...
    def _get_token(self) -> str:
        ...
        """
        return "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..irNJk1yN1_nAg6nebfJYa2W1xbtA3owIYpgqScysjtY"
